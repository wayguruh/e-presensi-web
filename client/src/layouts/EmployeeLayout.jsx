        ...
        <div className='py-4'>
          ...
          <ul className='mt-6'>
            <li className='relative px-6 py-3'>
              ...
              <a className={`inline-flex items-center w-full text-sm font-semibold ${location.pathname == '/'? 'text-gray-800' : 'text-gray-500'} transition-colors duration-150 hover:text-gray-800`} href='/'>
                { location.pathname == '/' ? (
            ...
            <li className='relative px-6 py-3'>
              ...
              <a className={`inline-flex items-center w-full text-sm font-semibold ${location.pathname == '/presence'? 'text-gray-800' : 'text-gray-500'} transition-colors duration-150 hover:text-gray-800`} href='/presence'>
                { location.pathname == '/presence' ? (
                ...
                <span className='ml-4'>Riwayat Absensi</span>
              </a>
            </li>
            <li className='relative px-6 py-3'>
              ...
              <a className={`inline-flex items-center w-full text-sm font-semibold ${location.pathname == '/timeoff'? 'text-gray-800' : 'text-gray-500'} transition-colors duration-150 hover:text-gray-800`} href='/timeoff'>
                { location.pathname == '/timeoff' ? (
                ...
                <span className='ml-4'>Request Izin/Cuti</span>
              </a>
            </li>
            <li className='relative px-6 py-3'>
              ...
              <a className={`inline-flex items-center w-full text-sm font-semibold ${location.pathname == '/profile'? 'text-gray-800' : 'text-gray-500'} transition-colors duration-150 hover:text-gray-800`} href='/profile'>
                { location.pathname == '/profile' ? (
